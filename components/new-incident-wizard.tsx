...
export default function NewIncidentWizard({ initialTopics, presetTopicSelections, persons, initialReasons }: NewIncidentWizardProps) {
    const [currentStep, setCurrentStep] = useState(0);

    return (
        <WizardProvider>
            <NewIncidentWizardSteps currentStep={currentStep} setCurrentStep={setCurrentStep} initialTopics={initialTopics} presetTopicSelections={presetTopicSelections} persons={persons} initialReasons={initialReasons} />
